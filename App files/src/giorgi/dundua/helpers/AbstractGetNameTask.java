...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void>{
    ...
    protected Authorization mActivity;

    protected String mScope;
    protected String mEmail;

    AbstractGetNameTask(Authorization activity, String email, String scope) {
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          String image = getProfileImage(response);
          mActivity.show(name);
          mActivity.setImageFromUrl(image);
          is.close();
          return;
        } else if (sc == 401) {
